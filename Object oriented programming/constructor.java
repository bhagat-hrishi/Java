class constructor 
{
    constructor()
    {
         this(12);
        // super();
        System.out.println("I am here inside No argument constructor");
    }
    constructor(int a)
    {
        System.out.println("I am here inside argument constructor");
    }
    ...
    {
        // System.out.println("It is legal to have method with same name as constructor but it is not good programming practice");
